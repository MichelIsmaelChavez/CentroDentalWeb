...
export default function Contacto() {
  return (
    <main className="min-h-screen pt-10 pb-16 px-6 bg-gradient-to-b from-white via-[#f0fdfa] to-[#d1f4ea] text-gray-800">
      <motion.h1
      ...
      >
        ...
        <div className="flex flex-col justify-center space-y-6 text-lg text-[#475569]">
          ...
          <p>📞 <strong>Teléfono:</strong> <a href="tel:+59169084318" className="text-[#2563eb] underline">+591 69084318</a></p>
          <p>💬 <strong>WhatsApp:</strong> <a href="https://wa.me/59169084318" target="_blank" rel="noopener noreferrer" className="text-[#2563eb] underline">Enviar mensaje</a></p>
          <p>✉️ <strong>Email:</strong> <a href="mailto:contacto@dental-suarez.com" className="text-[#2563eb] underline">contacto@dental-suarez.com</a></p>
